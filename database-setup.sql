...
/*
-- Sample kas data
INSERT INTO public.kas (user_id, keterangan, jumlah, jenis, kategori, tanggal) VALUES
('your-user-id-here', 'Dana awal kas', 1000000, 'masuk', 'Modal', '2024-01-01'),
('your-user-id-here', 'Pembelian alat tulis', 50000, 'keluar', 'Operasional', '2024-01-02'),
('your-user-id-here', 'Iuran bulanan', 200000, 'masuk', 'Iuran', '2024-01-03');

-- Sample anggota data
INSERT INTO public.anggota (user_id, nama, email, nickname, role, status) VALUES
('your-user-id-here', 'John Doe', 'john@example.com', 'John', 'Developer', 'aktif', '2024-01-01'),
('your-user-id-here', 'Jane Smith', 'jane@example.com', 'Jane', 'Designer', 'aktif', '2024-01-02'),
('your-user-id-here', 'Bob Wilson', 'bob@example.com', 'Bob', 'Manager', 'non-aktif', '2024-01-03');
*/
